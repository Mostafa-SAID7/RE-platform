...
@Component({
  ...
  template: `
    <div [class]="getAlertClasses()" [attr.role]="'alert'" [attr.aria-live]="'polite'">
      <div class="flex items-start">
        ...
        <div class="ml-3 flex-1">
          <h3 *ngIf="title" class="text-sm font-medium">
            {{ title }}
          </h3>
          <div [class.mt-2]="title" class="text-sm">
            {{ message }}
          </div>
        </div>
        <button
          *ngIf="closeable"
          (click)="onClose()"
          class="ml-3 inline-flex text-gray-400 hover:text-gray-500 dark:hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-offset-gray-900 rounded"
